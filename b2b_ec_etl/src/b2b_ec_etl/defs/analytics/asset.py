...
from b2b_ec_etl.defs.analytics.resources import dbt_project


@dbt_assets(manifest=dbt_project.manifest_path, project=dbt_project, name="dbt_models")
...
analytics_assets = [dbt_models, *dbt_source_assets]
